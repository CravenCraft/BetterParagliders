...
public class ServerConfig {
    ...
    public ServerConfig(ForgeConfigSpec.Builder server) {
        ...
        ONE_HANDED_STAMINA_CONSUMPTION = server.comment("How much more/less stamina is consumed from one handed (and dual wielding) attacks (multiplied onto the base amount) (stacks with MELEE_STAMINA_CONSUMPTION).")
